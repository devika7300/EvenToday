...
struct MarriageEventView: View {
    ...
    var body: some View {
        NavigationView {
            contentView
                .padding()
                .navigationTitle("Create Marriage Event")
    ...
    private var createEventButton: some View {
        Button(action: {
            ...
            eventViewModel.addEvent(ownerId: ownerId, name: eventTitle, date: eventDate, time: eventTime, eventType: "Marriage", budget: budgetValue, description: additionalInfo) { error in
                if let error = error {
                    print("Error: \(error)")
...
struct MarriageEventView_Previews: PreviewProvider {
